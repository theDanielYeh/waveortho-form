  ...
  return {
    ...
    LABELS: {
      ...
      TEXT_MESSAGE_CONSENT: {
        english: 'I consent to receive text messages at this phone number. Message frequency varies, message and data rates may apply. Message types may include: marketing (eg. Promos), patient care and/or conversational messages. Reply STOP to opt-out; HELP for more information.',
